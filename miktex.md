...
![MikTeX Console](images/miktexconsole.png)

In the MikTeX Console, go to the *Updates* tab, and click *Check for updates*.

![MikTeX Checking for Updates](images/miktexchecking.png)

If there are any updates available, click *Updates Page* to see the list of updates.

![MikTeX Updates Available](images/miktexupdatesavailable.png)

Click *Update now* to install the updates.

![MikTex Updating](images/miktexupdatenow.png)
